  ...
  <h3>Personal Info</h3>
   <div class="form-row d-flex">
      <div class="form-group col-md-6">
         <input type="text" class="form-control FirstName" value={FirstName} onChange={(e)=>{setFirstName(e.target.value)}} id="FirstName" placeholder='FirstName' />
   ...
   <div class="form-row d-flex">
      <div class="form-group col-md-6">
         <input type="email" class="form-control" value={email} onChange={(e)=>{setemail(e.target.value)}} id="email" placeholder="Email"/>
   ...
   <div class="form-group col-md-6">
      <input type="text" class="form-control" value={phoneNo} onChange={(e)=>{setphoneNo(e.target.value)}} id="phoneNo" placeholder="Phone No"/>
   ...
   <div class="form-row d-flex">
      <div class="form-group col-md-6">
         <input type="text" class="form-control" value={MedicalCondition} onChange={(e)=>{setMedicalCondition(e.target.value)}} id="MedicalCondition" placeholder='Any Medical Condition' />
      </div>
      <div class="form-group col-md-6">
         <input type="text" class="form-control" id="Medicines" value={Medicines} onChange={(e)=>{setMedicines(e.target.value)}} placeholder="Medicine's Used"/>
      </div>
   </div>
   </div>
   <div id="step3">
   ...
   <div class="form-row d-flex">
      <div class="form-group col-md-6">
         <input type="text" class="form-control" id="EmergencyCo" value={EmergencyCo} onChange={(e)=>{setEmergencyCo(e.target.value)}} placeholder='Emergency Co.' />
   ...
   <div class="form-row d-flex">
      ...
      <input type="text" class="form-control" value={FirstName} placeholder='FirstName' disabled/>
      </div>
      <div class="form-group col-md-6">
      <label>Last Name:</label>
      <input type="text" class="form-control" value={Lastname} placeholder='LastName' disabled/>
      </div>
   </div>
   <div class="form-row d-flex">
      <div class="form-group col-md-6">
   ...
   <div class="form-row d-flex">
      ...
      <input type="text" class="form-control" value={MedicalCondition} placeholder='MedicalCondition' disabled/>
      </div>
      <div class="form-group col-md-6">
      <label>Medicines:</label>
      <input type="text" class="form-control" value={Medicines} placeholder='Medicines' disabled/>
      </div>
   </div>
   <div class="form-row d-flex">
      <div class="form-group col-md-6">
      <label>Mobile No:</label>
      <input type="text" class="form-control" value={phoneNo} placeholder='phoneNo' disabled/>
      </div>
      <div class="form-group col-md-6">
      <label>Emergency No:</label>
      <input type="text" class="form-control" value={EmergencyCo} placeholder='EmergencyCo' disabled/>
      </div>
   </div>
   <p className="text-danger">{FinalMsg}</p>
   </div>
   <button type="" id="next" class="btn btn-primary next-btn" onClick={next}>Next</button>
<button type="" id="prev" class="btn btn-primary prev-btn" onClick={prev}>prev</button>
<button type="sumbit" id="submit" class="btn btn-primary submit-btn" onClick={submit}>Submit</button>
</form>
</div>
    </>
  )
